...
var krs = (function (krs, $) {
    ...
    krs.getMarketplaceItemHTML = function (good) {
        ...
        html += "</div>";
        html += "<div><h3 class='title'><a href='#' data-goods='" + krs.escapeRespStr(good.goods) + "' data-toggle='modal' data-target='#dgs_purchase_modal'>" + String(good.name).escapeHTML() + "</a></h3></div>";
    ...
    krs.getMarketplacePendingOrderHTML = function (purchase) {
        return "<div data-purchase='" + krs.escapeRespStr(purchase.purchase) + "'><div style='float:right;color: #999999;background:white;padding:5px;border:1px solid #ccc;border-radius:3px'>" +
            ...
            "<strong>" + $.t("product_id") + "</strong>: &nbsp;<a href='#'' data-toggle='modal' data-target='#dgs_product_modal' data-goods='" + krs.escapeRespStr(purchase.goods) + "'>" + krs.escapeRespStr(purchase.goods) + "</a>" +
            "</div>" +
            "<h3 class='title'><a href='#' data-purchase='" + krs.escapeRespStr(purchase.purchase) + "' data-toggle='modal' data-target='#dgs_view_purchase_modal'>" + String(purchase.name).escapeHTML() + "</a></h3>" +
    ...
    krs.forms.dgsDelistingComplete = function (response, data) {
        ...
        $("#my_dgs_listings_table").find("tr[data-goods=" + krs.escapeRespStr(data.goods) + "]").addClass("tentative tentative-crossed");
    };
        ...
        krs.sendRequest("getDGSGood", {
            ...
            if (response.errorCode) {
                ...
                if (type == "dgs_purchase_modal") {
                    krs.modalStack.push({
                        class: "dgs_show_picture_modal_action_purchase",
                        key: "data-goods",
                        value: goods
                    });
                } else if (type == "dgs_product_modal") {
                    krs.modalStack.push({
                        class: "dgs_show_picture_modal_action_product",
                        key: "data-goods",
                        value: goods
                    });
                }
