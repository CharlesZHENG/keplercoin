...
var krs = (function (krs, $) {
    ...
    krs.getMessageDownloadLink = function (transaction, sharedKey) {
        ...
        return "<a href='/kpl?requestType=downloadPrunableMessage&transaction=" + krs.escapeRespStr(transaction) +
    ...
    function getMessage(message) {
        ...
        if (!message.attachment) {
            ...
            krs.sendRequest("getPrunableMessage", {
    ...
    $("body").on("click", "a[data-goto-messages-account]", function (e) {
        ...
        krs.goToPage("messages", function () {
